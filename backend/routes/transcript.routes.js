...
import { handleTranscriptForRAG } from "../rag/ingestion/handleTranscript.js";
...
router.post("/", async (req, res) => {
  ...
  const { meetingId, participantName, originalText } = req.body;
  handleTranscriptForRAG(meetingId, participantName, originalText);
  res.sendStatus(201);
});
